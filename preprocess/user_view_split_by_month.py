...
def user_view_split_by_date():
    if(not os.path.exists(static_params.DATA_USER_VIEW_MONTH_PATH)):
        os.mkdir(static_params.DATA_USER_VIEW_MONTH_PATH)
    ...
    f = open(static_params.DATA_USER_VIEW_MONTH_PATH + '2016_10' + ".pkl", 'wb')
